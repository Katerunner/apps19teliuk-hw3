...
//                func);
    ...
    public static String[] findDistinctStudentNamesFrom2ndYearWithGPAgt4AndOrderedBySurname(Student[] students) {
        ...
        MyPredicate predicateSecYearGPA = t -> ((Student) t).getYear() == 2 && ((Student) t).getGPA() >= 4;
        MyFunction getStudentName = t -> ((Student) t).getSurname() + " " + ((Student) t).getName();
        MyComparator compareBySurname = (o1, o2) -> ((Student) o1).getSurname().compareTo(((Student) o2).getSurname());
